...
<div id="main-content">
	<div class="container">
		<div id="content-area" class="clearfix">
			...
			<?php if((isset($_GET['quote_search_submit'])) && (isset($_GET['quote_title']))){ ?>
				<?php $quote_title = $_GET['quote_title']; ?>
					<div class="search_wrapper clearfix">
					<label for="quote_title">Find quotes</label>
					<form class="quote-search-form clearfix" id="search_quotes" action="/quote-search-and-tag/" method="get">
