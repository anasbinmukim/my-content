		...
		<div class="entry-content">
			...
			<form class="quote-search-form clearfix" id="search_quotes" action="/<?php //echo get_permalink( get_option('quotes_page_id') ); ?>" method="get">
				<div class="form-group">
					<input type="text" name="s" id="quote_title" value="<?php echo $quote_title; ?>" class="form-control" placeholder="Keyword... " />
				</div>
				<input type="hidden" name="post_type" title="" value="quote" />
