...
class cmb_Meta_Box_types {
	...
	public function input( $args = array() ) {
		...
		return sprintf( '<input '.$args["disabled"].' %s/>%s', $this->concat_attrs( $args, 'desc' ), $args['desc'] );
	}
	...
	public function text_wp_title() {
		return $this->input( array(  'disabled' =>'disabled','value' => $this->field->escaped_value( 'esc_textarea' )  ,'desc' => get_the_title($this->field->escaped_value( 'esc_textarea' )) ) );
