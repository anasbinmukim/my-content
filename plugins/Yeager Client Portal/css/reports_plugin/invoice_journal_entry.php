...
// echo "Total Run".$k.
			...
			$final_data_table['all_dates']['Fine']=0;
...
// echo "<br>";
				//	echo $lineitem['desc']."===".$lineitem['total'];
					...
					elseif (strpos($lineitem['desc'], 'Fine for') !== false) {
					$final_data_table['all_dates']['Fine']=$final_data_table['all_dates']['Fine']+$lineitem['total'];	
					$final_total3=$final_total3+$lineitem['total'];
...
// }
					...
					if(strpos($lineitem['desc'], 'voice for') == false && strpos($lineitem['desc'], 'Standard Credit')== false )
						{
							// echo $lineitem['desc'];
							// echo "<br>";
					if (strpos($lineitem['desc'], 'Discount') !== false ) {
...
// echo "<br>";
					...
					elseif (strpos($lineitem['desc'], 'Key') !== false && strpos($lineitem['desc'], 'voice for') == false ) {
// echo $lineitem['desc'];
// echo "<br>";
					$final_data_table['all_dates']['Tenant Improvement']=$final_data_table['all_dates']['Tenant Improvement']+$lineitem['total'];
					$final_total3=$final_total3+$lineitem['total'];
...
// 				echo "<br>";
							...
							<td>  </td>
							   ...
							   <td><a onclick="submitResources_phone('<?php echo $start_account; ?>','<?php echo $end_account; ?>',<?php  echo $building; ?>,'<?php echo $key; ?>');" href="javascript:void(0);" title="#">$<?php echo number_format($value,2); ?></a></td>
							<td>Week of <?php echo $end_account; ?></td>
							<td> </td>
							<td> </td>
							<td><?php echo $class; ?> </td>
							...
							$csv_data_array[$i]['Account']="Accounts Receivable";
							$csv_data_array[$i]['Debit']="$".number_format($final_data_table['total'],2);
							$csv_data_array[$i]['Credit']="";
							$csv_data_array[$i]['Memo']="";
							$csv_data_array[$i]['Name']=" ";
							$csv_data_array[$i]['Billable']=" ";
							...
							<tr>
							<td>Accounts Receivable</td>
							<td>$<?php echo number_format($final_data_table['total'],2); ?></td>
							<td></td>
							<td> </td>
							<td> </td>
							<td> </td>
							...
							echo "Total Aux value is $".number_format($the_total_aux,2);
							echo "<br>";
							echo "Total Aux value without security deposit and without rebill is $".number_format($pendingaux,2);
							restore_current_blog();
