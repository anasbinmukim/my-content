...
switch ($_POST['_accounting_building_id']) {
	...
	<input type="submit" name="Run" value="Download"/>
				...
				<div class="wrap">
				<h2 class="mkbis2">Income journal r Reports for <?php echo $class; ?> From <?php echo $_POST['_accounting_start_date'];  ?> To <?php echo $_POST['_accounting_end_date'];?></h2>
				<?php
				$building=$_POST['_accounting_building_id'];
...
// echo "</pre>";
				...
				// 			echo "***********************************************************************************";
							...
							echo "Total Aux vvalue is ".$the_total_aux;
							restore_current_blog();
